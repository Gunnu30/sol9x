...
const EditStudent = () => {
  ...
  useEffect(() => {
    const fetchStudent = async () => {
      try {
        const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/admin/student/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const updatedData = {
        ...
        const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/admin/student/edit/${id}`, {
        method: "PATCH",
        headers: {
