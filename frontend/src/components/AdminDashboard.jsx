...
const AdminDashboard = () => {
  ...
  const getStudentDetails = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/admin/students` , {
        method:"GET"
      });
  ...
  const handleDelete = async (studentId) => {
    ...
    try {
        const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/admin/student/delete/${studentId}`, {
        method: "DELETE",
        headers: {
